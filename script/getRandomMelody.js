const {getRandomIntInclusive} = require('./noteUtilities');

/*eslint-disable complexity*/
// Arguments all optional
// Returns melody as array of midi codes. ex. [0, 30, 127]
function getRandomMelody({
  type = 'diatonic', // diatonic or chromatic.
  ...
  let result = [];
  let lastNote = getRandomIntInclusive(range.min, range.max); // So we can decide about repetition. Unused atm.
